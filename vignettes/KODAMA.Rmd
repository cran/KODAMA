...
The R package KODAMA (current version 1.1) is part of the Comprehensive R Archive Network (CRAN)^[http://cran.r-project.org]. The simplest way to install the package is to enter the following command into your R session: `install.packages("KODAMA")`. We suggest to install the R package `rgl` for the data visualization in 3D interactive plots.
